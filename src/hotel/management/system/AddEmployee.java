...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(phone.length() != 10 ){
            JOptionPane.showMessageDialog(null, "Length of Phone Number should be exactly 10");
            return;
        }
        ...
        if(aadhar.length() != 12){
            JOptionPane.showMessageDialog(null, "Length of Aadhar Number should be exactly 12");
            return;
        }
        
        if(!aadhar.matches("[0-9]+")){
            JOptionPane.showMessageDialog(null, "Only Digits allowed in Aadhar Number");
            return;
        }
